...
const CITY_NAMES = [
    ...
    { status: 2, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商22222品标题商品标题商品标题' },
    { status: 3, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商33333品标题商品标题商品标题' },
]

const CITY_NAMES1 = [
    { status: 1, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商11111品标题商品标题商品标题' },
    { status: 1, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商22222品标题商品标题商品标题' },
    { status: 1, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商33333品标题商品标题商品标题' },
]

const CITY_NAMES2 = [
    { status: 2, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商11111品标题商品标题商品标题' },
    { status: 2, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商22222品标题商品标题商品标题' },
    { status: 2, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商33333品标题商品标题商品标题' },
]

const CITY_NAMES3 = [
    { status: 3, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商11111品标题商品标题商品标题' },
    { status: 3, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商22222品标题商品标题商品标题' },
    { status: 3, title: '商品标题商品标题商品标题商品标题商品1标题商品标题1商33333品标题商品标题商品标题' },
]
        ...
        return (
            <View style={styles.containView}>
                ...
                <View style={styles.headTab}>
                    <TouchableOpacity style={styles.headTabView} onPress={this.toMyTask}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.headTabView} onPress={()=>{this.handleGOTo('Wallet')}}>
                        <Image
                            style={styles.headTabImg}
                    ...
                    <TouchableOpacity style={styles.headTabView} onPress={()=>{this.handleGOTo('Invitation')}}>
                        <Image
                            style={styles.headTabImg}
                    ...
                    <TouchableOpacity style={styles.headTabView} onPress={this.toHelpInfo}>
                        <Image
                            style={styles.headTabImg}
    ...
    reLoading = refreshing => {
        ...
        setTimeout(() => {
            ...
            if (refreshing) {
                ...
                let i = data.length - 1;
                for (i; i >= 0; i--) {
                    dataArrayBuffer.push(data[i])
                }
            } else {//底部加载push
                if (this.state.dataArray.length > 10) {
                    dataArrayBuffer = this.state.dataArray;
                } else {
                    dataArrayBuffer = this.state.dataArray.concat(data);
                }
